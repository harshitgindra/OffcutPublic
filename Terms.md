...
- Sell, resell, rent, lease, lend, distribute, or sublicense the App
- Use the App for any commercial purpose or in any commercial context without our prior written consent
- Remove, alter, or obscure any proprietary notices (including copyright notices) in the App
...
### 4.5 Refunds
All refund requests are handled by Apple in accordance with their refund policies. We do not issue refunds directly. To request a refund, use Apple's standard process via [reportaproblem.apple.com](https://reportaproblem.apple.com).
...
- **Accuracy of calculations**: While we strive to provide accurate cut layout optimization, the App is a planning tool only. You are solely responsible for verifying all measurements, dimensions, and cut plans before cutting any materials. Always double-check measurements before making cuts.
- **Fitness for a particular purpose**: Cut layout suggestions are optimized mathematically but may not account for all real-world factors such as wood grain, defects, actual tool behavior, or material tolerances.
- **Uninterrupted availability**: We do not guarantee that the App will be available at all times or free from errors or bugs.
- **No implied warranties**: To the fullest extent permitted by law, we disclaim all implied warranties of merchantability, fitness for a particular purpose, and non-infringement.
...
- We shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of materials, wasted cuts, property damage, or personal injury arising from your use of or reliance on the App.
- Our total liability to you for any claims arising from your use of the App shall not exceed the amount you paid for the App in the twelve (12) months preceding the claim.
...
- Any inaccuracies in the project data or measurements you enter into the App
